...
### YOUR CODE HERE
REGULARIZATION = [0.0000001, 0.000001, 0.00001, 0.0005, 0.001, 0.01, 0.1, 1]
### END YOUR CODE
...
#Simple loop to search through all the results firstly 
for result in results:

    #If the best performance exceeds the current best performance 
    if result["dev"] > BEST_DEV:

    #THen the value of the best regularization will be equal to whatever the achieved value is
